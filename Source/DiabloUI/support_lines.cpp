...
const char *const SupportLines[] = {
	...
	"",
	N_("Shadow of the West is maintained by Shadowed Pilgrims, issues and bugs can be reported at this address: https://github.com/Shadowed-Pilgrims/Shadow-of-the-West To help us better serve you, please be sure to include the version number, operating system, and the nature of the problem."),
	"",
	"",
	N_("Disclaimer:"),
