...
#else
		prefPath = FromSDL(SDL_GetPrefPath("shadowed-pilgrims", "shadow-of-the-west"));
#if !defined(__amigaos__)
		if (FileExistsAndIsWriteable("config.ini")) {
...
#else
		configPath = FromSDL(SDL_GetPrefPath("shadowed-pilgrims", "shadow-of-the-west"));
#if !defined(__amigaos__)
		if (FileExistsAndIsWriteable("config.ini")) {
